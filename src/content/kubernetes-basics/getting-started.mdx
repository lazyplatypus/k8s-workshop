...
[output] default           Active   13m
[output] kube-node-lease   Active   13m
[output] kube-public       Active   13m
[output] kube-system       Active   13m
```

## Pods

Reading: [Pods](https://kubernetes.io/docs/concepts/workloads/pods/)
...
[output] coredns-74ff55c5b-d2vpb                     1/1     Running   0          11m
[output] etcd-minikube-workshop                      1/1     Running   0          11m
[output] kube-apiserver-minikube-workshop            1/1     Running   0          11m
[output] kube-controller-manager-minikube-workshop   1/1     Running   0          11m
[output] kube-proxy-kgggq                            1/1     Running   0          11m
[output] kube-scheduler-minikube-workshop            1/1     Running   0          11m
[output] storage-provisioner                         1/1     Running   1          11m
```
...
[output] default       kubernetes   ClusterIP   10.96.0.1    <none>        443/TCP                  17m
[output] kube-system   kube-dns     ClusterIP   10.96.0.10   <none>        53/UDP,53/TCP,9153/TCP   17m
```
